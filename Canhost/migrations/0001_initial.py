    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hostel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Canhost.hostel')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hostel', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='Canhost.hostel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_mbl_no', models.PositiveIntegerField(default=None)),
                ('father_name', models.CharField(max_length=200, null=True)),
                ('father_mbl_no', models.PositiveIntegerField(default=None)),
                ...
                ('room', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Canhost.room')),
                ('user', models.OneToOneField(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Canhost.student')),
            ],
        ),
    ]
